(function(){
  ...
  var mobileTouch=/iPhone|iPad|iPod/.test(navigator.userAgent)||(navigator.platform==='MacIntel'&&navigator.maxTouchPoints>1)||(navigator.maxTouchPoints>0&&window.matchMedia('(hover:none)').matches);
...
@media(prefers-reduced-motion:reduce){
  .secret-trail-path,.secret-trail-tip,.secret-trail-label,.goal-eye.secret-prompt,.goal-secret-hint.secret-fly-away{animation-duration:.01ms!important;animation-iteration-count:1!important}
}
`;
